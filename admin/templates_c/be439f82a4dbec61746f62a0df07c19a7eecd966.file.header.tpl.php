<?php /* Smarty version Smarty-3.1.8, created on 2012-04-10 12:46:35
         compiled from "templates/header.tpl" */ ?>
<?php /*%%SmartyHeaderCode:14314764764f7efd5728a3f1-27666826%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '14314764764f7efd5728a3f1-27666826',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.8',
  'unifunc' => 'content_4f7efd57352e25_25574397',
  'variables' => 
  array (
    'jquery' => 0,
    'socialmedia' => 0,
...
<?php if ($_valid && !is_callable('content_4f7efd57352e25_25574397')) {function content_4f7efd57352e25_25574397($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
<head>
    ...
    <div class="navbar navbar-fixed-top">
      ...
      <div class="nav-collapse">
        <ul class="nav">
          ...
          <li class="add-border-left <?php if ($_smarty_tpl->tpl_vars['index']->value){?> active <?php }?>"><a href="hot-event.php" title="View the Hottest Event around!"><i class="icon-home icon-white "></i>Hot Event</a></li>
          ...
          <li class="add-border-left add-border-right <?php if ($_smarty_tpl->tpl_vars['subscribe']->value){?> active <?php }?>"><a id="nav" href="subscribe.php" title="Subscribe to Us!" >Subscribe</a></li>
        </ul>
