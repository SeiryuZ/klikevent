...
{include file="header.tpl" title="Klikevent.com" jquery="true" filter="true" todayEvent=true socialmedia=true}


<div class="section page-header">
    <h1> Events Pada Tanggal {$date} </h1>
    <div class="row">
        <div class="span2">
            <a href="events-date.php?date={$prevDate}"><i class="icon-chevron-left"></i>Previous Date</a>
        </div>
        <div class="span2 offset8">
            <a href="events-date.php?date={$nextDate}">Next Date<i class="icon-chevron-right"></i></a>
        </div>
    </div>
</div>
